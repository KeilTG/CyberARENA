...
const DEFAULT_EVENTS = [
  { id: '1', name: 'Турнир по CS2', category: 'CS2', format: '1v1', image: 'https://avatars.mds.yandex.net/i?id=14c3fb8458f9477e04ca23c176c4557d16988b87-5376016-images-thumbs&n=13', description: 'Одиночный турнир 1v1. Формат: до двух побед. Регистрация до начала турнира.', date: '15.04.2026', time: '18:00', maxParticipants: 16, rewards: [{ place: 1, text: '100 ARcoins' }, { place: 2, text: '50 ARcoins' }, { place: 3, text: '25 ARcoins' }] },
  { id: '2', name: 'Лига Valorant', category: 'Valorant', format: '5v5', image: 'https://avatars.mds.yandex.net/i?id=9b5281b0c6112cd51783bdf36493a7f5c95eb47c-5570459-images-thumbs&n=13', description: 'Командный турнир 5v5. Составы формируются на месте.', date: '22.04.2026', time: '17:00', maxParticipants: 32, rewards: [{ place: 1, text: '200 ARcoins (команда)' }, { place: 2, text: '100 ARcoins' }, { place: 3, text: '50 ARcoins' }] },
  { id: '3', name: 'Кубок Fortnite', category: 'Fortnite', format: '1v1', image: 'https://avatars.mds.yandex.net/i?id=729c0e427c6f358ad90adb133ec540e8d9799ea4-12384307-images-thumbs&n=13', description: 'Королевская битва. Три игры по лучшему результату.', date: '10.04.2026', time: '19:00', maxParticipants: 24, rewards: [{ place: 1, text: '150 ARcoins' }, { place: 2, text: '75 ARcoins' }, { place: 3, text: '30 ARcoins' }] },
  { id: '4', name: 'Арена Clash Royale', category: 'Clash Royale', format: '1v1', image: 'https://avatars.mds.yandex.net/i?id=85574e0425b7a702bbd8b671c82246c3f13b7c4d-5089284-images-thumbs&n=13', description: 'Турнир в формате лестницы. Один проигрыш — выбывание.', date: '18.04.2026', time: '18:30', maxParticipants: 16, rewards: [{ place: 1, text: '80 ARcoins' }, { place: 2, text: '40 ARcoins' }, { place: 3, text: '20 ARcoins' }] },
  { id: '5', name: 'Битва Brawl Stars', category: 'Brawl Stars', format: '3v3', image: 'https://avatars.mds.yandex.net/i?id=85f2d2ef155d1136b44a19be1dbb8c074d0405f1-5700464-images-thumbs&n=13', description: 'Командные матчи 3v3. Групповая стадия и плей-офф.', date: '25.04.2026', time: '17:30', maxParticipants: 24, rewards: [{ place: 1, text: '120 ARcoins' }, { place: 2, text: '60 ARcoins' }, { place: 3, text: '30 ARcoins' }] },
  { id: '6', name: 'Танковый марафон WOT', category: 'WOT', format: '5v5', image: 'https://avatars.mds.yandex.net/i?id=f855ad5781257e0ef90b150acf718b476f1f21f8-3689335-images-thumbs&n=13', description: 'Серия командных боёв. Побеждает команда с большим числом побед.', date: '12.04.2026', time: '18:00', maxParticipants: 20, rewards: [{ place: 1, text: '100 ARcoins' }, { place: 2, text: '50 ARcoins' }, { place: 3, text: '25 ARcoins' }] }
];
