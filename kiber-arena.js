...
/** Доступные слоты бронирования: зал 9:00–18:00, только эти периоды по 20 мин */
...
function initBookingTimePicker() {
    ...
    var dateInput = document.getElementById('booking-date-input');
    if (!listEl) return;
    var slots = ALLOWED_BOOKING_SLOTS;
...
document.getElementById('booking-form').addEventListener('submit', function(e) {
    ...
    var allowed = ALLOWED_BOOKING_SLOTS.some(function(s) { return s.start === timeStart && s.end === timeEnd; });
    if (!allowed) {
